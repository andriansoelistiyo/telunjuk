  ...
  <div class="card-grid mb-2">
    <div class="header-content">
      <div class="media">
        ...
        <div class="media-body flex-mobile">
          <span v-for="uvp in uvps" :key="uvp.id" class="badge badge-pill badge-uvp fs-12px mx-4px">
            {{ uvp.value }}</span>
        </div>
      </div>
    </div>
...
<script>
export default {
  name: "tCatalogDetailMoreMerchant",
  props: {
    item: {
      type: Object,
      required: true,
...
@import "assets/styles/scss/breakpoints";
